...
extern double save_test_data0[2251];

extern double save_test_data1[2251];

extern double save_test_data2[2251];

extern double dist[2251];
extern int TP,TN,FP,FN;

extern double threshold;

extern int anomaly;

extern double accuracy,precision,recall,F1;
